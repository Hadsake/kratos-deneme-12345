...
exports.run = (client, message, args) => {
  ...
  let modlog = guild.channels.find('name', 'kayıtlar');
  if (!modlog) return message.reply('`kayıtlar` kanalını bulamıyorum.');
  ...
  .addField('Uyarılan:', `${user.username}#${user.discriminator}`)
