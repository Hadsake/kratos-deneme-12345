...
const tweetend = new Discord.RichEmbed()
    ...
    .setTitle("<:tweet:396663805456809988> Tweet Tweet! <:tweet:396663805456809988>")
...
exports.run = async (bot, message, args) => {
    /*
    if(message.author.id !== '396663805456809988' && message.author.id !== '396663805456809988') return;
